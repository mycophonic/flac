		...
		blocks: []*meta.Block{
			{
				...
				Body: &meta.VorbisComment{
					...
					Tags: [][2]string{
						{"Description", "Waving a bamboo staff"},
						{"YEAR", "2008"},
		...
		blocks: []*meta.Block{
			{
				...
				Body: &meta.VorbisComment{
					...
					Tags: [][2]string{
						...
						{"Artist Homepage", "http://qubodup.net"},
						{"Artist Email", "qubodup@gmail.com"},
						{"DATE", "2012"},
					},
				},
			},
		...
		blocks: []*meta.Block{
			{
				...
				Body: &meta.SeekTable{
					Points: []meta.SeekPoint{
						{SampleNum: 0x0, Offset: 0x0, NSamples: 0x1200},
						{SampleNum: 0x1200, Offset: 0xe, NSamples: 0x4f8},
					...
					Tracks: []meta.CueSheetTrack{
						{
							...
							Indicies: []meta.CueSheetTrackIndex{
								{Offset: 0x0, Num: 0x1},
								{Offset: 0x24c, Num: 0x2},
							},
						},
						{
							Offset:         0xb7c,
							...
							IsAudio:        true,
							HasPreEmphasis: false,
							Indicies:       []meta.CueSheetTrackIndex{{Offset: 0x0, Num: 0x1}},
						},
						{
							Offset:         0x16f8,
							Num:            0xaa,
							...
							IsAudio:        true,
							HasPreEmphasis: false,
							Indicies:       []meta.CueSheetTrackIndex(nil),
						},
					},
				},
			},
	...
	},
	{
		...
		blocks: []*meta.Block{
			...
			},
			{
				...
				Body: &meta.VorbisComment{
					Vendor: "reference libFLAC 1.1.3 20060805",
					Tags: [][2]string{
